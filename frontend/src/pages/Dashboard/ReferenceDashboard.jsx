...
export default function ReferenceDashboard() {
  ...
  const cards = [
    ...
    { key: "reports", title: "تقارير الشهر", color: "#8b5cf6", tint: "#faf8ff", icon: <DescriptionOutlinedIcon />, items: [{ label: "تقارير", value: number(reportsSummary.count), icon: <DescriptionOutlinedIcon fontSize="inherit" /> }, { label: "فاوتشر", value: number(reportsSummary.vouchers), icon: <ReceiptLongOutlinedIcon fontSize="inherit" /> }, { label: "إجازات", value: number(reportsByType.Vacation), icon: <BeachAccessOutlinedIcon fontSize="inherit" /> }], footer: `قيمة المبيعات: ${money(reportsSummary.salesValue)}` },
