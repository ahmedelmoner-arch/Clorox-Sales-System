...
export default function ChartsPage() {
  ...
  return <AppShell hideHeader><Stack spacing={2.2}><Stack direction={{ xs: "column", md: "row" }} alignItems={{ md: "center" }} justifyContent="space-between" spacing={1.4}><Box><Typography variant="h5" fontWeight={900}>داشبورد الأداء</Typography><Typography variant="body2" color="text.secondary">ملخص تحليلي لشهر {formatMonth(month)}</Typography></Box><TextField size="small" type="month" label="الشهر" value={month} onChange={(event) => setMonth(event.target.value)} InputLabelProps={{ shrink: true }} sx={{ width: { xs: "100%", sm: 185 } }} /></Stack>
